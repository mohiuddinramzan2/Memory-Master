...
const Navigation = {
  ...
  _bindModals() {
    DOM.closeStatsBtn.addEventListener('click', () => Utils.closeOverlay(DOM.statsModal));
    DOM.closeAchievementsBtn.addEventListener('click', () => Utils.closeOverlay(DOM.achievementsModal));
    DOM.closeSettingsBtn.addEventListener('click', () => Utils.closeOverlay(DOM.settingsModal));
